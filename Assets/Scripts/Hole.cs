...
public class Hole : MonoBehaviour
{
	private void OnTriggerStay(Collider other)
	{
		if (GameManager.Instance.Runner.IsServer)
		{
			...
			{
				player.PlayerObj.TimeTaken = (GameManager.Instance.Runner.Simulation.Tick - GameManager.Instance.TickStarted) * GameManager.Instance.Runner.Simulation.DeltaTime;
